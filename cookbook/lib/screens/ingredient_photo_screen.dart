...
class _IngredientPhotoScreenState
  ...
  // คู่มือการใช้งาน: ข้อกำหนดการวางวัตถุดิบ
                  ...
                  child: ListView(
                    ...
                    children: [
                      _buildTipCard(
                        '🎯 วิธีวางในกรอบ',
                        [
                          'วัตถุดิบ 1 ชิ้นต่อรูป (อย่าให้มีหลายชิ้นซ้อนกัน)',
                          'วางให้อยู่ “ตรงกลาง” กรอบสี่เหลี่ยม',
                          'ให้ขนาดวัตถุดิบพอดีกรอบ ประมาณ 70–90% ของกรอบ',
                          'อย่าให้ส่วนสำคัญหลุดออกนอกกรอบสแกน',
                          'ใช้เส้นไกด์ในกรอบช่วยจัดวางให้นิ่งและเที่ยงตรง',
                        ],
                      ),
                      _buildTipCard(
                        '🧼 พื้นหลังและความสะอาด',
                        [
                          'ใช้พื้นหลังเรียบ/สีอ่อน (เช่น ขาว เทา อ่อน)',
                          'เก็บโต๊ะให้โล่ง ไม่มีวัตถุอื่นรอบๆ',
                          'เช็ดเลนส์กล้องให้สะอาดก่อนถ่าย',
                        ],
                      ),
                      _buildTipCard(
                        '💡 แสงสว่าง',
                        [
                          'ถ่ายในที่แสงเพียงพอ (แสงธรรมชาติจะดีที่สุด)',
                          'หลีกเลี่ยงเงาแรงและแสงย้อน',
                          'เปิดไฟฉายหากแสงไม่พอ เพื่อให้สีสันใกล้เคียงของจริง',
                        ],
                      ),
                      _buildTipCard(
                        '✅ ตัวอย่างที่ดี',
                        [
                          'เห็นรูปทรงและลักษณะเด่นของวัตถุดิบชัดเจน',
                          'วางราบหรือวางแนวตามเส้นไกด์ที่กำหนด',
                          'ไม่มีมือ จานชาม หรือสิ่งอื่นบังวัตถุดิบ',
                        ],
                      ),
                      _buildTipCard(
                        '⚠️ ควรหลีกเลี่ยง',
                        [
                          'มีหลายชิ้นอยู่ในกรอบเดียวกัน',
                          'วัตถุดิบอยู่ไกล/เล็กเกินไปในกรอบ',
                          'พื้นหลังลายพราง สีใกล้เคียงกับวัตถุดิบมาก',
                          'ถ่ายผ่านถุงพลาสติก/บรรจุภัณฑ์',
                          'มีตัวหนังสือหรือสติ๊กเกอร์ติดอยู่บนวัตถุดิบ',
                        ],
                      ),
  ...
  PreferredSizeWidget _buildAppBar(ThemeData theme) {
    ...
    return AppBar(
      ...
      actions: [
        // ปุ่มคู่มือการวางวัตถุดิบ (Help '?') มุมขวาบน
        Padding(
            padding: EdgeInsets.only(top: topGuard),
            child: IconButton(
              icon: const Icon(Icons.help_outline),
              tooltip: 'วิธีใช้งาน/ข้อกำหนดการวางวัตถุดิบ',
